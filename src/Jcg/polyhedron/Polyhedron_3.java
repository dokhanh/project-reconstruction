 ...
 */	    
    public boolean isValid(boolean borders) {
        ...
        System.out.println("n,e,f: "+n+"  "+e/2+"  "+f);
        int g=-(n-e/2+f-2)/2;
 ...
 */	    
    ...
    public static void main(String[] args) {
    	System.out.println("Testing Polyhedron_3 class");
		MeshRepresentation m=new MeshRepresentation();
    	m.readOffFile(args[0]);
    	LoadMesh<Point_3> l=new LoadMesh<Point_3>();    	
    	Polyhedron_3<Point_3> polyhedron=l.createPolyhedron(m.points,m.faceDegrees,m.faces,m.sizeHalfedges);
    	
    	new MeshViewer(polyhedron);
    	polyhedron.isValid(true);
    	//System.out.println(""+polyhedron.facesToString());
