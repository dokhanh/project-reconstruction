...
public class MeshRepresentation {
    ...
    static final int max_degree=30;
    ...
    public void readOffFile(String filename){
    	...
    	String line;
    	System.out.println(" ---\nCreating a mesh representation from OFF file");
    	try{
    		System.out.println("opening an OFF file... "+filename);
...
//            size_halfedges=Integer.parseInt(tok.nextToken());
            ...
            int i=0;
            Point_3 point;
            System.out.print("Reading vertices..."+sizeVertices);
        ...
        System.out.println("vertices "+sizeVertices+"   faces "+sizeFaces+"   halfegdes "+sizeHalfedges);
        //for(int i=0;i<sizeFaces;i++){
            //System.out.print("degree "+faceDegrees[i]+"  ");
            //for(int j=0;j<faceDegrees[i];j++) System.out.print(" "+faces[i][j]);
            //System.out.println();
        //}
